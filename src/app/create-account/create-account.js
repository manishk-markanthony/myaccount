...
import { API_ROOT, BRAND_WCB, COMPANY_ID, COUNTRY_US, CREATE_ACCOUNT_POLICY_ID, METHOD_GET, PING_RUN_FLOW, SK_API_KEY, SK_GET_TOKEN_URL } from "@/util/constant";
            ...
            .then((responseData) => {
                var props = {
                    config: {
                        ...
                        policyId: CREATE_ACCOUNT_POLICY_ID,
                        parameters: {
